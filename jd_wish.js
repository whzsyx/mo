...
[task_local]
#众筹许愿池
40 0,2 * * * jd_wish.js, tag=众筹许愿池, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
...
===============Surge=================
众筹许愿池 = type=cron,cronexp="40 0,2 * * *",wake-system=1,timeout=3600,script-path=jd_wish.js

============小火箭=========
众筹许愿池 = type=cron,script-path=jd_wish.js, cronexpr="40 0,2 * * *", timeout=3600, enable=true
 */
const $ = new Env('众筹许愿池');
...
let appIdArr = ["1EFZWxKqP","1FFVQyqw","1EFRQwA", "1E1xZy6s","1EFdRwqyF"];
let appNameArr = ["新品来袭","1111点心动","疯狂砸金蛋","PLUS生活特权", "春尚新送好礼"];
let appId, appName;
$.shareCode = [];
if ($.isNode()) {
